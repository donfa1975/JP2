...
/**
 * Represents an abstract shell of to be used as JSF Controller to be used in AJAX-enabled applications. No outcomes will be generated from its methods since handling is designed to be done inside one page.
 *
...
public abstract class AbstractController<T> implements Serializable {
	...
	/**
	 * Retrieve the current EJB Facade object so that other beans in this package can perform additional data layer tasks (e.g. additional queries)
	 *
	...
	/**
	 * Set any isChildEntityEmpty flags, if any children are defined in entity. This method should be overridden inside specific entity controllers if the entity has any OneToMany relationships. (see specific controllers for more detail.
	 *
	 */
	...
	/**
	 * Sets any embeddable key fields if an Entity uses composite keys. If the entity does not have composite keys, this method performs no actions and exists purely to be overridden inside a concrete controller class.
	 */
	...
	/**
	 * Performs any data modification actions for an entity. The actions that can be performed by this method are controlled by the {@link PersistAction} enumeration and are either CREATE, EDIT or DELETE.
	 *
