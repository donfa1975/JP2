...
public class LazyEntityDataModel<T> extends LazyDataModel<T> {
	...
	/**
	 * Retrieves an entity's Row Key by returning a String representation of hashCode. Note: Instead of trying to identify the ACTUAL key field or fields in this generic method, the code depends on the hashCode method of the entity, which has typically been generated by NetBeans and combines the key fields into a hash number! This is supposed to be a unique number according to the hashCode JavaDoc entry. If you are using a PrimeFaces DataTable with Lazy Loading enabled, please DO NOT specify the "rowKey" attribute, which the CRUD Generator normally adds. It will break getting the RowData which depends on the getRowKey method's return value of a hashCode. However, if "rowKey" is specified on the DataTable, THIS method (getRowKey) will not be called. I hope this is clear to understand.
	 *
	 * @param object
	 * @return
	 */
